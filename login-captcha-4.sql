...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 10, 2025 at 05:04 PM
...
(1, 'Default', '', 1, '2025-09-10 08:44:10', '2025-09-10 08:44:10');
...
CREATE TABLE IF NOT EXISTS `oc_article_comment` (
...
CREATE TABLE IF NOT EXISTS `oc_article_rating` (
...
(1, 'Pound Sterling', 'GBP', '£', '', 2, 0.73765327, 1, '2025-09-10 10:28:52'),
(2, 'US Dollar', 'USD', '$', '', 2, 1.00000000, 1, '2025-09-10 10:28:52'),
(3, 'Euro', 'EUR', '', '€', 2, 0.85149864, 1, '2025-09-10 10:28:52'),
(4, 'Hong Kong Dollar', 'HKD', 'HK$', '', 2, 7.78763624, 0, '2025-09-10 10:28:52'),
(5, 'Indian Rupee', 'INR', '₹', '', 2, 88.16970368, 0, '2025-09-10 10:28:52'),
(6, 'Russian Ruble', 'RUB', '', '₽', 2, 56.40360000, 0, '2018-02-16 12:00:00'),
(7, 'Chinese Yuan Renminbi', 'CNY', '¥', '', 2, 7.12150886, 0, '2025-09-10 10:28:52'),
(8, 'Australian Dollar', 'AUD', '$', '', 2, 1.51319823, 0, '2025-09-10 10:28:52');
...
(45, 'login_captcha', 'module', 'login_captcha');
...
(2, 0, 0, 'OpenCart Language Example', 'This extension is only here for so developers can see how to create a language extension for OpenCart.', 'oc_language_example', '1.0', 'OpenCart Ltd', 'https://www.opencart.com', 0, '2025-09-10 08:46:03'),
(3, 0, 0, 'OpenCart OCMOD Example', '', 'oc_ocmod_example', '1.0', 'OpenCart Ltd', 'https://www.opencart.com', 0, '2025-09-10 08:46:03'),
(4, 0, 0, 'OpenCart Payment Example', 'This extension is only here for so developers can see how to create a payment extension for OpenCart.', 'oc_payment_example', '1.0', 'OpenCart Ltd', 'https://www.opencart.com', 0, '2025-09-10 08:46:03'),
(5, 0, 0, 'OpenCart Theme Example', 'This extension is only here for so developers can see how to create a theme extension for OpenCart.', 'oc_theme_example', '1.0', 'OpenCart Ltd', 'https://www.opencart.com', 0, '2025-09-10 08:46:03'),
(8, 0, 0, 'Login Captcha', 'Login Captcha', 'login_captcha', '1.0', 'iExtendLabs', 'https://iextendlabs.com', 1, '2025-09-10 09:30:42');
...
CREATE TABLE IF NOT EXISTS `oc_extension_path` (
  ...
  KEY `path` (`path`)
) ENGINE=InnoDB AUTO_INCREMENT=450 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
(432, 8, 'login_captcha'),
(433, 8, 'login_captcha/admin'),
(434, 8, 'login_captcha/admin/controller'),
(435, 8, 'login_captcha/admin/controller/module'),
(436, 8, 'login_captcha/admin/controller/module/captcha'),
(437, 8, 'login_captcha/admin/controller/module/captcha/basic.php'),
(438, 8, 'login_captcha/admin/controller/module/login_captcha.php'),
(439, 8, 'login_captcha/admin/language'),
(440, 8, 'login_captcha/admin/language/en-gb'),
(441, 8, 'login_captcha/admin/language/en-gb/module'),
(442, 8, 'login_captcha/admin/language/en-gb/module/login_captcha.php'),
(443, 8, 'login_captcha/admin/view'),
(444, 8, 'login_captcha/admin/view/template'),
(445, 8, 'login_captcha/admin/view/template/module'),
(446, 8, 'login_captcha/admin/view/template/module/captcha'),
(447, 8, 'login_captcha/admin/view/template/module/captcha/basic.twig'),
(448, 8, 'login_captcha/admin/view/template/module/login_captcha.twig'),
(449, 8, 'login_captcha/install.json');
...
CREATE TABLE IF NOT EXISTS `oc_order_subscription` (
...
('b6c0bda465d861482f07c8bba1', '{\"currency\":\"USD\",\"captcha\":\"0035da\",\"user_id\":\"1\",\"user_token\":\"9957cfc183b54f1cdadb1527f30ddd39\"}', '2025-09-11 13:42:59');
...
(224, 0, 'module_login_captcha', 'module_login_captcha_status', '1', 0);
...
CREATE TABLE IF NOT EXISTS `oc_subscription_option` (
...
CREATE TABLE IF NOT EXISTS `oc_subscription_product` (
...
CREATE TABLE IF NOT EXISTS `oc_topic_to_layout` (
  `topic_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  `layout_id` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `oc_topic_to_store` (
  `topic_id` int NOT NULL,
  `store_id` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`topic_id`,`store_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
(1, 1, 'admin', '$2y$10$A1E12u.uEgY.HJrOK/AUW.JraSAWI/6vkgNaxj2joj4RhOM9uV/He', 'John', 'Doe', 'admin@gmail.com', '', '::1', 1, '2025-09-10 08:44:10');
...
(1, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 08:45:55'),
(2, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 09:49:45'),
(3, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 10:14:31'),
(4, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 10:19:42'),
(5, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 10:22:53'),
(6, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 10:25:18'),
(7, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 10:28:34'),
(8, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 10:29:38'),
(9, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 10:30:34'),
(10, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 11:24:16'),
(11, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-10 13:42:59');
